...
\mbox{}\verb@@\\
\mbox{}\verb@/* fortran routines get special treatment */@\\
\mbox{}\verb@/* windows format is upper case names, no underscore */@\\
\mbox{}\verb@/*6/29/10: compiled on windows with gfortran, and so underscore is indeed needed */@\\
\mbox{}\verb@/*#ifdef WIN32@\\
\mbox{}\verb@extern void DORGQR();@\\
\mbox{}\verb@extern void DNAUPD();@\\
\mbox{}\verb@extern void DNEUPD();@\\
\mbox{}\verb@extern void DGEESX();@\\
\mbox{}\verb@extern void DGEQPF();@\\
\mbox{}\verb@extern void MA50ID();@\\
\mbox{}\verb@extern void MA50AD();@\\
\mbox{}\verb@extern void MA50BD();@\\
\mbox{}\verb@extern void MA50CD();@\\
\mbox{}\verb@#define dorgqr_ DORGQR@\\
\mbox{}\verb@#define dnaupd_ DNAUPD@\\
\mbox{}\verb@#define dneupd_ DNEUPD@\\
\mbox{}\verb@#define dgeesx_ DGEESX@\\
\mbox{}\verb@#define dgeqpf_ DGEQPF@\\
\mbox{}\verb@#define ma50id_ MA50ID@\\
\mbox{}\verb@#define ma50ad_ MA50AD@\\
\mbox{}\verb@#define ma50bd_ MA50BD@\\
\mbox{}\verb@#define ma50cd_ MA50CD@\\
\mbox{}\verb@#define finite(x) _finite(x)@\\
\mbox{}\verb@*/@\\
\mbox{}\verb@/* sun format is lower case, with underscore (default in source code)@\\
\mbox{}\verb@#else@\\
\mbox{}\verb@*/@\\
\mbox{}\verb@/*@\\
\mbox{}\verb@extern void dorgqr_();@\\
\mbox{}\verb@extern void dnaupd_();@\\
\mbox{}\verb@extern void dneupd_();@\\
