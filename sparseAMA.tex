...
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@#define MAXELEMSA 381@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@#define HCOLS 39@\\
\mbox{}\verb@#define LEADS 8@\\
\mbox{}\verb@@\\
\mbox{}\verb@#define MAXELEMSB 592@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@double hmat[MAXELEMSA]=@\\
...
\mbox{}\verb@unsigned int hmatj[MAXELEMSA]=@\\
\mbox{}\verb@{1, 4, 7, 10, 11, 13, 1, 3, 4, 6, 7, 8, 9, 10, 11, 12, 14, 12, 15, 37};@\\
\mbox{}\verb@unsigned int hmati[4]={1, 7, 18,21 };@\\
\mbox{}\verb@double hmat2[MAXELEMSA]={-1., 0.1, 1., -0.5, -0.5, -0.5, -0.5, 1., -0.3, -1., 1., -0.2, 1.,  1.};@\\
\mbox{}\verb@unsigned int hmat2j[MAXELEMSA]=@\\
\mbox{}\verb@{7, 8, 9, 10, 15, 4, 9, 10, 3, 6, 8, 10, 6, 7};@\\
\mbox{}\verb@unsigned int hmat2i[6]={1, 6, 9, 13, 14, 15};@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@double zmat2[MAXELEMSA]={-0.5, -0.5, 1., -0.3, -1., 1., -0.2, 1., 1.};@\\
\mbox{}\verb@unsigned int zmat2j[MAXELEMSA]=@\\
\mbox{}\verb@{4, 9, 10, 3, 6, 8, 10, 6, 7};@\\
\mbox{}\verb@unsigned int zmat2i[5]={1, 4, 8, 9, 10};@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@double * newHmat;unsigned int * newHmatj;unsigned int * newHmati;@\\
...
\mbox{}\verb@{@\\
\mbox{}\verb@@\\
\mbox{}\verb@newHmat=(double *)calloc((unsigned)MAXELEMSA,sizeof(double));@\\
\mbox{}\verb@newHmatj=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@newHmati=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@qmat=(double *)calloc((unsigned)MAXELEMSA,sizeof(double));@\\
\mbox{}\verb@qmatj=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@qmati=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@bmat=(double *)calloc((unsigned)MAXELEMSA,sizeof(double));@\\
\mbox{}\verb@bmatj=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@bmati=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@rootr=(double *)calloc((unsigned)MAXELEMSA,sizeof(double));@\\
\mbox{}\verb@rooti=(double *)calloc((unsigned)MAXELEMSA,sizeof(double));@\\
\mbox{}\verb@@\\
\mbox{}\verb@annihil=(double *)calloc((unsigned)MAXELEMSA,sizeof(double));@\\
\mbox{}\verb@annihilj=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@annihili=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@@\\
\mbox{}\verb@theR=(double *)calloc((unsigned)MAXELEMSA,sizeof(double));@\\
\mbox{}\verb@theRj=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@theRi=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@@\\
\mbox{}\verb@prow=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@pcol=(unsigned int *)calloc((unsigned)MAXELEMSA,sizeof(unsigned int));@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@rowsInQ=aux=0;@\\
\mbox{}\verb@qmati[0]=1;@\\
\mbox{}\verb@maxSize=MAXELEMSA;@\\
...
\mbox{}\verb@   );@\\
\mbox{}\verb@     CU_ASSERT(MAXELEMSA  == maxSize)@\\
\mbox{}\verb@     CU_ASSERT(0 == retCode)@\\
\mbox{}\verb@maxSize=MAXELEMSB;@\\
\mbox{}\verb@obtainSparseReducedForm(@\\
\mbox{}\verb@  &maxSize,@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@  printf("testSparseAMA2:after autoregressiona call\n");@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@int clean_suite1(void);@\\
\mbox{}\verb@int clean_suite2(void);@\\
\mbox{}\verb@void testSparseAMA(void);@\\
\mbox{}\verb@void testSparseAMA2(void);@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
