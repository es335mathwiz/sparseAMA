...
\item \NWtxtFileDefBy\ \NWlink{nuweb14}{14}\NWlink{nuweb15}{, 15}\NWlink{nuweb16}{, 16}\NWlink{nuweb17}{, 17}\NWlink{nuweb18}{, 18}\NWlink{nuweb19}{, 19}.
...
\mbox{}\verb@        norm=0;@\\
\mbox{}\verb@        useCNRMS(&neq, &norm, hmat, hmatj, hmati, diag) ;@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@/* strings are char arrays, so don't take addresses when calling */@\\
\mbox{}\verb@/*#ifdef WIN32@\\
\mbox{}\verb@        useDNEUPD( &rvec, huhmat, ONE, select, rootr, rooti, spanVecs, &ldv,@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@        useDNEUPD( &rvec, huhmat, select, rootr, rooti, spanVecs, &ldv,@\\
...
\mbox{}\verb@                        computing a subset of eigenvectors, so use useCSRCSC2 */@\\
\mbox{}\verb@                        useCSRCSC2(&nroot,&nroot,&job,&job,a,ja,ia,ta,tja,tia);@\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb19}{} \verb@"devsparseAMA.c"@\nobreak\ {\footnotesize {19}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@/*@\\
...
\mbox{}\verb@static FILE* temp_file = NULL;@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@static const unsigned int maxelems=381;@\\
\mbox{}\verb@@\\
\mbox{}\verb@newHmat=(double *)calloc((unsigned)maxelems,sizeof(double));@\\
\mbox{}\verb@newHmatj=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@newHmati=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@qmat=(double *)calloc((unsigned)maxelems,sizeof(double));@\\
\mbox{}\verb@qmatj=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@qmati=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@bmat=(double *)calloc((unsigned)maxelems,sizeof(double));@\\
\mbox{}\verb@bmatj=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@bmati=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@annihil=(double *)calloc((unsigned)maxelems,sizeof(double));@\\
\mbox{}\verb@annihilj=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@annihili=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@@\\
\mbox{}\verb@theR=(double *)calloc((unsigned)maxelems,sizeof(double));@\\
\mbox{}\verb@theRj=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@theRi=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@@\\
\mbox{}\verb@prow=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@pcol=(unsigned int *)calloc((unsigned)maxelems,sizeof(unsigned int));@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@rowsInQ=aux=0;@\\
\mbox{}\verb@qmati[0]=1;@\\
\mbox{}\verb@maxSize=maxelems;@\\
\mbox{}\verb@   if (NULL == (temp_file = fopen("temp.txt", "w+"))) {@\\
\mbox{}\verb@      return -1;@\\
\mbox{}\verb@   }@\\
\mbox{}\verb@   else {@\\
\mbox{}\verb@      return 0;@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@int clean_suite1(void)@\\
\mbox{}\verb@{@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@   if (0 != fclose(temp_file)) {@\\
\mbox{}\verb@      return -1;@\\
\mbox{}\verb@   }@\\
\mbox{}\verb@   else {@\\
\mbox{}\verb@      temp_file = NULL;@\\
\mbox{}\verb@      return 0;@\\
\mbox{}\verb@   }@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@\\
\mbox{}\verb@/* Simple test of sparseAMA().@\\
\mbox{}\verb@ * Writes test data to the temporary file and checks@\\
\mbox{}\verb@ * whether the expected number of bytes were written.@\\
\mbox{}\verb@ */@\\
\mbox{}\verb@void testSparseAMA(void)@\\
\mbox{}\verb@{@\\
\mbox{}\verb@static const unsigned int hrows=3;@\\
\mbox{}\verb@static const unsigned int hcols=39;@\\
\mbox{}\verb@static const unsigned int leads=1;@\\
\mbox{}\verb@static const unsigned int lags=1;@\\
\mbox{}\verb@@\\
\mbox{}\verb@double normVec[hrows];@\\
\mbox{}\verb@double hmat[20]=@\\
...
\mbox{}\verb@unsigned int hmatj[20]=@\\
\mbox{}\verb@{1, 4, 7, 10, 11, 13, 1, 3, 4, 6, 7, 8, 9, 10, 11, 12, 14, 12, 15, 37};@\\
\mbox{}\verb@unsigned int hmati[4]={1, 7, 18,21 };@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@   );@\\
\mbox{}\verb@/*%     CU_ASSERT(maxelems  == maxSize)*/@\\
\mbox{}\verb@     CU_ASSERT(0 == retCode)@\\
\mbox{}\verb@/*@\\
\mbox{}\verb@obtainSparseReducedForm(@\\
\mbox{}\verb@  &maxSize,@\\
\mbox{}\verb@  hrows*leads,(hcols-hrows),qmat,qmatj,qmati,@\\
...
\mbox{}\verb@{@\\
\mbox{}\verb@@\\
\mbox{}\verb@static const unsigned int hrows=1;@\\
\mbox{}\verb@static const unsigned int hcols=3;@\\
\mbox{}\verb@static const unsigned int leads=1;@\\
\mbox{}\verb@static const unsigned int lags=1;@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@  printf("testSparseAMA2:beginning\n");@\\
\mbox{}\verb@double hmat[14]={-1., 0.1, 1., -0.5, -0.5, -0.5, -0.5, 1., -0.3, -1., 1., -0.2, 1.,  1.};@\\
\mbox{}\verb@unsigned int hmatj[14]=@\\
\mbox{}\verb@{7, 8, 9, 10, 15, 4, 9, 10, 3, 6, 8, 10, 6, 7};@\\
\mbox{}\verb@unsigned int hmati[6]={1, 6, 9, 13, 14, 15};@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@double zmat[9]={-0.5, -0.5, 1., -0.3, -1., 1., -0.2, 1., 1.};@\\
\mbox{}\verb@unsigned int zmatj[9]=@\\
\mbox{}\verb@{4, 9, 10, 3, 6, 8, 10, 6, 7};@\\
\mbox{}\verb@unsigned int zmati[5]={1, 4, 8, 9, 10};@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@printf("here's h\n");@\\
\mbox{}\verb@cPrintSparse(5,   hmat,hmatj,hmati);@\\
\mbox{}\verb@@\\
\mbox{}\verb@sparseAMA(&maxSize,@\\
\mbox{}\verb@   DISCRETE_TIME,@\\
\mbox{}\verb@   hrows,hcols,leads,@\\
...
\mbox{}\verb@cPrintSparse(5,   newHmat,newHmatj,newHmati);@\\
\mbox{}\verb@printf("here's q\n");@\\
\mbox{}\verb@cPrintSparse(5,   qmat,qmatj,qmati);@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@cPrintSparse(5,   bmat,bmatj,bmati);@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@   prow,pcol);@\\
\mbox{}\verb@printf("here's newh again\n");@\\
\mbox{}\verb@cPrintSparse(hrows,   newHmat,newHmatj,newHmati);@\\
\mbox{}\verb@printf("here's q\n");@\\
\mbox{}\verb@cPrintSparse(hrows-1,   qmat,qmatj,qmati);@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@  printf("testSparseAMA2:after autoregression call\n");@\\
\mbox{}\verb@@\\
\mbox{}\verb@  printf("testSparseAMA2:end\n");@\\
\mbox{}\verb@@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@static const unsigned int leads=1;@\\
\mbox{}\verb@static const unsigned int lags=1;@\\
\mbox{}\verb@static const unsigned int maxelems=3;@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@  printf("testSparseAMA2:beginning\n");@\\
...
\mbox{}\verb@cPrintSparse(hrows,   newHmat,newHmatj,newHmati);@\\
\mbox{}\verb@printf("here's q\n");@\\
\mbox{}\verb@cPrintSparse(hrows*leads,qmat,qmatj,qmati);@\\
\mbox{}\verb@@\\
\mbox{}\verb@/*@\\
\mbox{}\verb@obtainSparseReducedForm(&maxSize,@\\
\mbox{}\verb@  hrows, hrows*(leads+lags),@\\
\mbox{}\verb@  qmat,qmatj,qmati,@\\
\mbox{}\verb@  bmat,bmatj,bmati@\\
\mbox{}\verb@);@\\
\mbox{}\verb@*/@\\
\mbox{}\verb@printf("here's b\n");@\\
\mbox{}\verb@cPrintSparse(hrows*(leads+lags),bmat,bmatj,bmati);@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@autoRegression(&maxSize,&retCode,@\\
\mbox{}\verb@   hrows,hcols,@\\
...
\NWtarget{nuweb?}{} \verb@"devuseSparseAMA.h"@\nobreak\ {\footnotesize {?}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@/*@\\
...
\item \verb@"devsparseAMA.c"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb14}{14}\NWlink{nuweb15}{, 15}\NWlink{nuweb16}{, 16}\NWlink{nuweb17}{, 17}\NWlink{nuweb18}{, 18}\NWlink{nuweb19}{, 19}.
}
\item \verb@"devuseSparseAMA.h"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb?}{?}.}
\end{list}}
